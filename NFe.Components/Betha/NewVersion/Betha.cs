...
namespace NFe.Components.Betha.NewVersion
{
    public class Betha : BethaBase
    {
        ...
        public Betha(TipoAmbiente tpAmb, int codMun, string usuario, string senhaWs, string proxyuser, string proxypass, string proxyserver)
            : base(tpAmb, codMun, usuario, senhaWs, proxyuser, proxypass, proxyserver)
        { }
