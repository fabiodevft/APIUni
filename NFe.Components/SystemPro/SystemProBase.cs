...
namespace NFe.Components.SystemPro
{
    public abstract class SystemProBase : EmiteNFSeBase
    {
        ...
        public SystemProBase(TipoAmbiente tpAmb, X509Certificate certificate, int codMun)
            : base(tpAmb)
        {
            Certificate = certificate;
            CodMun = codMun;
        ...
        {
            string strResult = Invoke("EnviarLoteRpsSincrono", new[] { NfseCabecMsg, xml.InnerText });
        ...
        {
            string strResult = Invoke("CancelarNfse", new[] { NfseCabecMsg, xml.InnerText });
        ...
        {
            string strResult = Invoke("ConsultarNfseFaixa", new[] { NfseCabecMsg, xml.InnerText });
