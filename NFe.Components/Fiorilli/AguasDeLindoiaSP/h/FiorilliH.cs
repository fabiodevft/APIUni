...
namespace NFe.Components.Fiorilli.AguasDeLindoiaSP.h
{
    public class FiorilliH : EmiteNFSeBase
    {
        ...
        private string EnvioSincrono(XmlDocument xml)
        {
            ...
            string strResult = SerializarObjeto(Service.gerarNfse(envio, UsuarioWs, SenhaWs));
        ...
        private string EnvioSincronoEmLote(XmlDocument xml)
        {
            ...
            string strResult = SerializarObjeto(Service.recepcionarLoteRpsSincrono(envio, UsuarioWs, SenhaWs));
