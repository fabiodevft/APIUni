...
using NFe.Components.HGoianaPE_TINUS_CancelarNfse;
using NFe.Components.HGoianaPE_TINUS_RecepcionarLoteRps;
using NFe.Components.HGoianaPE_TINUS_ConsultarNfse;
using NFe.Components.HGoianaPE_TINUS_ConsultarLoteRps;
using NFe.Components.HGoianaPE_TINUS_ConsultarNfsePorRps;
using NFe.Components.HGoianaPE_TINUS_ConsultarSituacaoLoteRps;
using System.Net;
using System.Security.Cryptography.X509Certificates;
using System.Xml;

namespace NFe.Components.Tinus.GoianaPE.h
{
