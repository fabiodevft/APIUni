...
using NFe.Components.PGoianaPE_TINUS_CancelarNfse;
using NFe.Components.PGoianaPE_TINUS_RecepcionarLoteRps;
using NFe.Components.PGoianaPE_TINUS_ConsultarNfse;
using NFe.Components.PGoianaPE_TINUS_ConsultarLoteRps;
using NFe.Components.PGoianaPE_TINUS_ConsultarNfsePorRps;
using NFe.Components.PGoianaPE_TINUS_ConsultarSituacaoLoteRps;
using System.Net;
using System.Security.Cryptography.X509Certificates;
using System.Xml;

namespace NFe.Components.Tinus.GoianaPE.p
{
