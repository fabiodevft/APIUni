...
using NFe.Components.HCabedeloPB_TINUS_CancelarNfse;
using NFe.Components.HCabedeloPB_TINUS_RecepcionarLoteRps;
using NFe.Components.HCabedeloPB_TINUS_ConsultarNfse;
using NFe.Components.HCabedeloPB_TINUS_ConsultarLoteRps;
using NFe.Components.HCabedeloPB_TINUS_ConsultarNfsePorRps;
