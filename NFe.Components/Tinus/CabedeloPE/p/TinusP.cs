...
using NFe.Components.PCabedeloPB_TINUS_CancelarNfse;
using NFe.Components.PCabedeloPB_TINUS_RecepcionarLoteRps;
using NFe.Components.PCabedeloPB_TINUS_ConsultarNfse;
using NFe.Components.PCabedeloPB_TINUS_ConsultarLoteRps;
using NFe.Components.PCabedeloPB_TINUS_ConsultarNfsePorRps;
using NFe.Components.PCabedeloPB_TINUS_ConsultarSituacaoLoteRps;
using System.Net;
using System.Security.Cryptography.X509Certificates;
using System.Xml;

namespace NFe.Components.Tinus.CabedeloPB.p
{
    public class TinusP : EmiteNFSeBase
    {
        ...
        public override void ConsultarNfsePorRps(string file)
        {
            ...
            //var strResult = Service.CallConsultarNfsePorRps(envio);
