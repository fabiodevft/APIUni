...
using NFe.Components.HCaboDeSantoAgostinhoPE_TINUS_CancelarNfse;
using NFe.Components.HCaboDeSantoAgostinhoPE_TINUS_RecepcionarLoteRps;
using NFe.Components.HCaboDeSantoAgostinhoPE_TINUS_ConsultarNfse;
using NFe.Components.HCaboDeSantoAgostinhoPE_TINUS_ConsultarLoteRps;
using NFe.Components.HCaboDeSantoAgostinhoPE_TINUS_ConsultarNfsePorRps;
using NFe.Components.HCaboDeSantoAgostinhoPE_TINUS_ConsultarSituacaoLoteRps;
using System.Net;
using System.Security.Cryptography.X509Certificates;
using System.Xml;

namespace NFe.Components.Tinus.CaboDeSantoAgostinhoPE.h
{
