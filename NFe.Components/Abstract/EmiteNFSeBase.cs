...
namespace NFe.Components.Abstract
{
    public abstract class EmiteNFSeBase : IEmiteNFSe
    {
        ...
        public EmiteNFSeBase(TipoAmbiente tpAmb)
        {
            this.tpAmb = tpAmb;
        }
        ...
        public virtual XmlDocument CancelarNfse(XmlDocument xml)
        {
            throw new NotImplementedException();
        }

        public virtual XmlDocument ConsultarLoteRps(XmlDocument xml)
        {
            throw new NotImplementedException();
        }

        public virtual XmlDocument ConsultarNfse(XmlDocument xml)
        {
            throw new NotImplementedException();
        }

        public virtual XmlDocument ConsultarNfsePorRps(XmlDocument xml)
        {
            throw new NotImplementedException();
        }

        public virtual XmlDocument ConsultarSituacaoLoteRps(XmlDocument xml)
        {
            throw new NotImplementedException();
        }

        public virtual XmlDocument ConsultarNfseServicoTomado(XmlDocument xml)
        {
            throw new NotImplementedException();
        }

        public virtual XmlDocument EmiteNF(XmlDocument xml)
        {
            throw new NotImplementedException();
        }
    }
