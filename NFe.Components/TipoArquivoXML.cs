...
namespace NFe.Components
{
    public class TipoArquivoXML
    {
        ...
        public TipoArquivoXML(XmlDocument conteudoXML, int UFCod, bool soValidar)
        {
            DefinirTipoArq(conteudoXML, UFCod, soValidar);
        }
        ...
        private void DefinirTipoArq(XmlDocument conteudoXML, int UFCod, bool soValidar)
        {
            bool nfse = (UFCod.ToString().Length == 7) || (UFCod == 202);
            bool reinf = (conteudoXML.DocumentElement.Name == "Reinf");
            bool esocial = (conteudoXML.DocumentElement.Name == "eSocial");
