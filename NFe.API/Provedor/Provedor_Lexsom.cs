...
{
    internal class Provedor_Lexsom : AbstractProvedor, IProvedor
    {

        internal Provedor_Lexsom()
        {
            this.Nome = EnumProvedor.Lexsom;
        }
        ...
        {
            if (nota.Provedor.Nome != EnumProvedor.Lexsom)
            {
                                ...
                                case EnumResposta.ConsultarNfseRpsResposta:
                                    {
                                        ...
                                        {
                                            case "infnfse":
                                                identificador = x.GetAttribute("id").ToString();
                                                break;
            ...
            //            linkImpressaoAux = "http://nfse.pmfi.pr.gov.br/nfseweb/NFSE/ImprimeNFSE?I=" + identificador + "&actionReferencia=prestador";
            //            break;
            //    }
            //}
        ...
        public override XmlDocument GeraXmlNota(NFSeNota nota)
        {
            ...
            var nodeLoteRps = Extensions.CriarNo(doc, gerarNotaNode, "LoteRps", "", "id", "L" + nota.Documento.TDFe.Tide.FNumeroLote);
            ...
            var Listarps = Extensions.CriarNo(doc, nodeLoteRps, "ListaRps");
            ...
            vsAttribute.Value = "R" + nota.Documento.TDFe.Tide.FIdentificacaoRps.FNumero;
            ...
            Extensions.CriarNoNotNull(doc, ServicoValoresNode, "BaseCalculo", FormataValor(nota.Documento.TDFe.TServico.FValores.FBaseCalculo, 2));
            Extensions.CriarNoNotNull(doc, ServicoValoresNode, "Aliquota", nota.Documento.TDFe.TServico.FValores.FAliquota > 0 ? FormataValor(nota.Documento.TDFe.TServico.FValores.FAliquota / 100, 4) : "0");
        ...
        public override XmlDocument GerarXmlCancelaNota(NFSeNota nota, string numeroNFSe, string motivo)
        {
            ...
            var InfPedidoCancelamentoNode = Extensions.CriarNo(doc, PedidoNode, "InfPedidoCancelamento", "", "id",
                                                        "C_" + nota.Documento.TDFe.Tide.FIdentificacaoRps.FNumero);
