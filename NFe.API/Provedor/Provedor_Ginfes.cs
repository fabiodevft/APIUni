...
{
    public class Provedor_Ginfes : AbstractProvedor, IProvedor
    {
        internal Provedor_Ginfes()
        {
            this.Nome = EnumProvedor.Ginfes;
        }
        ...
        {
            if (nota.Provedor.Nome != EnumProvedor.Ginfes)
            {
        ...
        public override XmlDocument GeraXmlNota(NFSeNota nota)
        {
           var doc = new XmlDocument();
            ...
            var enviarLoteRpsEnvio = CriaHeaderXml("EnviarLoteRpsEnvio", ref doc, "http://www.ginfes.com.br/servico_enviar_lote_rps_envio_v03.xsd");

            string[] prefixo = {"tipos", "http://www.ginfes.com.br/tipos_v03.xsd"};

            #region LoteRps
            var loteRps = Extensions.CriarNo(doc, enviarLoteRpsEnvio, "LoteRps", "", "Id", "LOTE" + nota.Documento.TDFe.Tide.FNumeroLote);

            var vsAttribute = doc.CreateAttribute("xmlns:tipos");
            loteRps.Attributes.Append(vsAttribute);
            vsAttribute.Value = "http://www.ginfes.com.br/tipos_v03.xsd";

            Extensions.CriarNo(doc, loteRps, "NumeroLote", nota.Documento.TDFe.Tide.FNumeroLote.ToString(), prefixo);
            Extensions.CriarNoNotNull(doc, loteRps, "Cnpj", nota.Documento.TDFe.TPrestador.FCnpj, prefixo);
            ...
            Extensions.CriarNoNotNull(doc, nodeServicoValores, "ValorDeducoes", FormataValor(nota.Documento.TDFe.TServico.FValores.FValorDeducoes, 2), prefixo);
            ...
            Extensions.CriarNoNotNull(doc, nodeServicoValores, "OutrasRetencoes", FormataValor(nota.Documento.TDFe.TServico.FValores.FvalorOutrasRetencoes, 2), prefixo);
            ...
            switch (nota.Documento.TDFe.TPrestador.TEndereco.FCodigoMunicipio)
            {
                case "3540705": /*Porto Ferreira - SP*/
                case "3518305": /*GUARAREMA - SP*/
                case "2704302": /*Maceió-AL*/
                case "3525102": /*JARDINÓPOLIS-SP*/
                    break;
                default:
            ...
            {
                Extensions.CriarNoNotNull(doc, nodeServico, "Discriminacao", Generico.RemoverCaracterEspecial(nota.Documento.TDFe.TServico.FDiscriminacao.Replace("&amp;", "e").Replace("&", "e")), prefixo);
            }
            else
            {
                switch (nota.Documento.TDFe.TPrestador.TEndereco.FCodigoMunicipio)
                {
                    case "3518305": /*GUARAREMA - SP*/
                    case "2704302": /*Maceió-AL*/
                    case "3549904": /*São José dos Campos*/
                    case "4208955": /*JARDINÓPOLIS-SP*/
                        ...
                        + "\r\n" + "\r\n" + "\r\n" + "\r\n"
                        + Generico.TrocarCaractercomAcentos(nota.Documento.TDFe.Tide._FMsgComplementares.Replace("&amp;", "e").Replace("&", "e").Replace("\n", "\r\n")), prefixo);
                        break;

                    default:
                        Extensions.CriarNoNotNull(doc, nodeServico, "Discriminacao", Generico.TrocarCaractercomAcentos(nota.Documento.TDFe.TServico.FDiscriminacao.Replace("&amp;", "e").Replace("&", "e")), prefixo);
                        break;
                }

            }
            
            Extensions.CriarNoNotNull(doc, nodeServico, "CodigoMunicipio", nota.Documento.TDFe.TServico.FCodigoMunicipio, prefixo);
            ...
            Extensions.CriarNo(doc, nodePrestador, "Cnpj", nota.Documento.TDFe.TPrestador.FCnpj, prefixo);
        ...
        public override XmlDocument GerarXmlConsulta(NFSeNota nota, long numeroLote)
        {
            ...
            var doc = new XmlDocument();
            var nodeGerarConsulta = CriaHeaderXml("ConsultarLoteRpsEnvio", ref doc, "http://www.ginfes.com.br/servico_consultar_lote_rps_envio_v03.xsd");

            var valAttribute = doc.CreateAttribute("xmlns:tipos");
            valAttribute.Value = "http://www.ginfes.com.br/tipos_v03.xsd";
            nodeGerarConsulta.Attributes.Append(valAttribute);

            #region Prestador
            var nodePrestador = Extensions.CriarNo(doc, nodeGerarConsulta, "Prestador");

            Extensions.CriarNoNotNull(doc, nodePrestador, "Cnpj", nota.Documento.TDFe.TPrestador.FCnpj, prefixo);
            Extensions.CriarNoNotNull(doc, nodePrestador, "InscricaoMunicipal", nota.Documento.TDFe.TPrestador.FInscricaoMunicipal, prefixo);
        ...
        public override XmlDocument GerarXmlConsulta(NFSeNota nota, string numeroNFSe, DateTime emissao)
        {
            ...
            var doc = new XmlDocument();
            var nodeGerarConsulta = CriaHeaderXml("ConsultarNfseRpsEnvio", ref doc, "http://www.ginfes.com.br/servico_consultar_nfse_rps_envio_v03.xsd");
            ...
            var vsAttributePrestador = doc.CreateAttribute("xmlns:tipos");
            vsAttributePrestador.Value = "http://www.ginfes.com.br/tipos_v03.xsd";

            nodePrestador.Attributes.Append(vsAttributePrestador);
        ...
        public override XmlDocument GerarXmlCancelaNota(NFSeNota nota, string numeroNFSe, string motivo)
        {
            ...
            string[] prefixo = { "tipos", "http://www.ginfes.com.br/tipos" };

            var nodeCancelaNota = CriaHeaderXml("CancelarNfseEnvio", ref doc, "http://www.ginfes.com.br/servico_cancelar_nfse_envio");

            var valAttribute = doc.CreateAttribute("xmlns:tipos");
            valAttribute.Value = "http://www.ginfes.com.br/tipos";
            nodeCancelaNota.Attributes.Append(valAttribute);

            #region Prestador
            var nodePrestador = Extensions.CriarNo(doc, nodeCancelaNota, "Prestador");
            ...
            Extensions.CriarNoNotNull(doc, nodeCancelaNota, "NumeroNfse", numeroNFSe);
