...
{
    internal class Provedor_BHISS : AbstractProvedor, IProvedor
    {
        internal Provedor_BHISS()
        {
            this.Nome = EnumProvedor.Metropolis;
        }
        ...
        public override XmlDocument GeraXmlNota(NFSeNota nota)
        {
            ...
            var CabLoteRps = Extensions.CriarNo(doc, gerarNotaNode, "LoteRps", "", "Id", "L" + nota.Documento.TDFe.Tide.FIdentificacaoRps.FNumero);
        ...
        public override XmlDocument GerarXmlCancelaNota(NFSeNota nota, string numeroNFSe)
        {
            ...
            var PedidoNode = Extensions.CriarNo(doc, gerarNotaNode, "Pedido", "", "xmlns", "http://www.abrasf.org.br/nfse.xsd");
