...
using static NFe.Full.API.Model.NFSeModel;
using static NFe.Full.API.Domain.Notas;
using static NFe.Full.API.Domain.XMLNFSe;
using static NFe.Full.API.Util.Extensions;

namespace NFe.Full.API.Domain
{
    ...
    public class NFSeNota
    {
        ...
        {
            var po = new NFe.Full.API.Domain.XMLNFSe.NFe
            {
            ...
            var serializer = new XmlSerializer(typeof(NFe.Full.API.Domain.XMLNFSe.NFe));
