...
using static UniAPI.Model.NFSeModel;
using static UniAPI.Domain.Notas;
using static UniAPI.Domain.XMLNFSe;
...
namespace UniAPI.Domain
{
    ...
    public class NFSeNota
    {
        ...
        {
            var po = new UniAPI.Domain.XMLNFSe.NFe
            {
            ...
            var serializer = new XmlSerializer(typeof(UniAPI.Domain.XMLNFSe.NFe));
